<template>
    <div class="profile">
        <div class="container pt-5">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="col-md-6">
                            <div class="input-group mb-5">
                                <input type="text" class="form-control" placeholder="Search Employee Info Like .. Id/Name/Email" v-model="search">
            ...
            <div class="d-flex justify-content-center" v-if="profile.length != 0">
                        ...
                        <div class="d-flex justify-content-center" v-if="profile.rel_social">
                            <ul class="social" v-for="social in profile.rel_social" :key="social._id">
                                <li v-if="social.social_name == 'Facebook'">
                                    <a :href="social.social_url"><img src="/images/icon/fb.png" alt=""
                                            class="social-icon"></a>
                                </li>
                                <li v-if="social.social_name == 'Twitter'">
                                    <a :href="social.social_url"><img src="/images/icon/twi.png" alt=""
                                            class="social-icon"></a>
                                </li>
                                <li v-if="social.social_name == 'Instagram'">
                                    <a :href="social.social_url"><img src="/images/icon/ins.png" alt=""
                                            class="social-icon"></a>
                                </li>
                                <li v-if="social.social_name == 'LinkedIn'">
                                    <a :href="social.social_url"><img src="/images/icon/linkedin.png" alt=""
                                            class="social-icon"></a>
                                </li>
                                <li v-if="social.social_name == 'WhatsApp'">
                                    <a :href="social.social_url"><img src="/images/icon/whatsapp.png" alt=""
                                            class="social-icon"></a>
                                </li>
                            </ul>
                        </div>
...
export default {
    ...
    methods: {
        searchEmployee() {
            this.$axios.get('/profile-search/' + this.search)
                .then(response => {
