...
<template>
  <div class="notice-page">
    ...
    <div class="container">
       <div class="notice-body" v-if="evenrt">
           <p class="notice-date">Published Date <span class="pl-3">{{evenrt.published_date}}</span> </p>
...
export default{
  ...
  mounted(){
   ...
   methods: {
     getEventDetails() {
      this.$axios.$get("/event-details/"+this.$route.params.id)
        .then((res) => {          
